        ...
        <div class="">
            <div class="row">
                <div class="col-sm-3 col-md-3 noImprimir">
                    <div class="card">
                        <form action="Controlador?menu=VentaBoleta" method="POST">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="dni" placeholder="Ingresar DNI">
                                    <button class="btn btn-outline-secondary" name="accion" type="submit" value="BuscarClienteDNI"><i class="bi bi-search"></i></button>
                                </div>

                                <div class="form-floating mt-2">
                                    <input type="text" class="form-control" value="${dniCliente}"  id="dni">
                                    <label for="dni">DNI</label>
                                </div>

                                <div class="form-floating mt-2">
                                    <input type="text" class="form-control" value="${nombreCliente}" name="nombrecompleto" id="nombrecompleto">
                                    <label for="nombrecompleto">Nombre y Apellidos</label>
                                </div>

                                <div class="form-floating mt-2">
                                    <input type="text" class="form-control" name="direccionCliente" id="direccion" style="height: 100px">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-end mt-1">
                                <div class="col-sm-2 col-md-2">
                                    <a href="Controlador?menu=VentaBoleta&accion=Cancelar" class="btn btn-danger noImprimir"><i class="bi bi-x"></i> Cancelar</a>
                                </div>

                                <div class="col-sm-2 col-md-2">
                                    <a href="Controlador?menu=VentaBoleta&accion=GenerarVentaBoleta" class="btn btn-success noImprimir" onclick="print()"><i class="bi bi-bag-check"></i> Generar Venta</a>
                                </div>
                            </div>
                        </div>
                    </div>
